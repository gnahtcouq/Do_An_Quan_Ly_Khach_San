...
void nhapMotNhanVien(DanhSachNhanVien &dsnv) {
    ...
    do {
        ...
        if (nv.taiKhoan == "admin") {
            cout << "\n\t(!) Tài khoản không được trùng với tài khoản Admin" << "\n";
        } else if (nv.taiKhoan.length() > 30) {
            cout << "\n\t(!) Tài khoản không được lớn hơn 30 kí tự. Xin hãy nhập lại" << "\n";
        } else if (kiemTraTaiKhoanNhanVienTrung(nv.taiKhoan) == true)
            cout << "\n\t(!) Tài khoản đã tồn tại. Xin hãy nhập lại" << "\n";
    ...
    do {
        ...
        if (nv.matKhau.length() > 30) {
            cout << "\n\t(!) Mật khẩu không được lớn hơn 30 kí tự. Xin hãy nhập lại" << "\n";
        }
    ...
    do {
        ...
        if (nv.soDienThoai.length() <= 0 || nv.soDienThoai.length() > 10 || nv.soDienThoai.length() != 10) {
            cout << "\n\t(!) Số điện thoại không hợp lệ. Xin hãy nhập lại" << "\n";
        }
    ...
    do {
        ...
        cin >> nv.ten;
        if (nv.ten.length() > 8) {
            cout << "\n\t(!) Tên không được lớn hơn 8 kí tự. Xin hãy nhập lại" << "\n";
        }
    ...
    do {
        ...
        cin >> nv.ho;
        if (nv.ho.length() > 8) {
            cout << "\n\t(!) Họ không được lớn hơn 8 kí tự xin hãy nhập lại" << "\n";
        }
    ...
    system("cls");
    cout << "\n\t(!) Tạo tài khoản thành công. Mã tài khoản là " << nv.ma << "\n";
}
...
void inDanhSachNhanVien(DanhSachNhanVien dsnv) {
    ...
    cout << setw(7) << left << "| Mã"
         << "|";
    cout << setw(23) << left << " Họ tên"
         << "|";
    cout << setw(33) << left << " Tài khoản"
         << "|";
    cout << setw(34) << left << " Mật khẩu"
         << "|";
    cout << setw(18) << left << " Số điện thoại"
         << "|" << "\n";
    cout << "*-----*--------------------*------------------------------*------------------------------*--------------*" << "\n";
    inMotNhanVien(dsnv);
    cout << "*-----*--------------------*------------------------------*------------------------------*--------------*" << "\n";
